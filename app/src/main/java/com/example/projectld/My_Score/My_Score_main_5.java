...
public class My_Score_main_5 extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Title.setText("คะแนนแบบฝึกที่ 5");
    ...
    public void setData_Score(){
        ...
        ArrayList Groupname = databaseHelper.SearchGroupName_hard(user.getString("UserID",null));
        ...
        if (Groupname != null) {
            ...
            for (int i = 0; i < Groupname.size(); i++) {
                ...
                ArrayList<HorizontalModel> horizontalModels = databaseHelper.item_word_Ranking_hard
    ...
    public void setData_Rank(){
        ...
        if (Groupname != null) {
            ...
            for (int i = 0; i < Groupname.size(); i++) {
                ...
                ArrayList<Ranking_Item> horizontalModels = databaseHelper.rank_ex3_hard(String.valueOf(Groupname.get(i)));
