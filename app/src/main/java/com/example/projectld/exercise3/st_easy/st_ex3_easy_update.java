...
import com.example.projectld.exercise3.st_nomal.st_ex3_normal_update;
                    ...
                    if (selectedRows.size() > 0) {
                        ...
                        if (Groupname.getText().toString().length() < 3){
                            ...
                            if (Check_Group == null || GroupName.equals(old_GroupName)) {
                                ...
                                Toast.makeText(st_ex3_easy_update.this,"ชื่อแบบทดสอบซ่ำกัน กรุณาเปลี่ยนชื่อแบบทดสอบ",Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                }
