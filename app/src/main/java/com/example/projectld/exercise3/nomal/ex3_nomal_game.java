...
@SuppressLint("NewApi")
public class ex3_nomal_game extends AppCompatActivity implements PopupMenu.OnMenuItemClickListener{
            ...
            public void onClick(View v) {
                ...
                if (!textView.getTag().equals("done")){
                    if (textView.getTag().equals(status)){
                        ...
                        if (finish == start){
                            //Toast.makeText(ex3_nomal_game.this,"เสร็จสิ้น",Toast.LENGTH_SHORT).show();
