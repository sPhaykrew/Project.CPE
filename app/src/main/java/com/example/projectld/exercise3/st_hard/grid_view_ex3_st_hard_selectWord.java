...
public class grid_view_ex3_st_hard_selectWord extends AppCompatActivity {
...
//            Groupname.setText("");
            Toast.makeText(grid_view_ex3_st_hard_selectWord.this, "กรุณาเลือก 5 คำ", Toast.LENGTH_SHORT).show();
        } else {
...
//                            Groupname.setHintTextColor(Color.parseColor("#EF5350"));
//                            Groupname.setText("");
                            Toast.makeText(grid_view_ex3_st_hard_selectWord.this, "ชื่อสั้นเกินไป", Toast.LENGTH_SHORT).show();
                        } else if (Groupname.getText().toString().length() > 8){
//                            Groupname.setHint("ชื่อยาวเกินไป");
//                            Groupname.setHintTextColor(Color.parseColor("#EF5350"));
//                            Groupname.setText("");
                            Toast.makeText(grid_view_ex3_st_hard_selectWord.this, "ชื่อยาวเกินไป", Toast.LENGTH_SHORT).show();
                        } else {
                            ...
                            if (Check_Group == null) {
                                for (String word : wordid_group) {
                                    ...
                                    databaseHelper.insert_group(sentence, GroupName, "Setting_ex3_hard", "sentenceID");
                                }
                                databaseHelper.insert_score_hard(GroupName);
                                Toast.makeText(grid_view_ex3_st_hard_selectWord.this, "เพิ่มข้อมูลแล้ว", Toast.LENGTH_SHORT).show();
                                st_ex3_hard_menu.close_activity.finish();
                                Intent intent = new Intent(grid_view_ex3_st_hard_selectWord.this, st_ex3_hard_menu.class);
                                startActivity(intent);
                                finish();
                            } else {
                                Toast.makeText(grid_view_ex3_st_hard_selectWord.this,"ชื่อแบบทดสอบซ่ำกัน กรุณาเปลี่ยนชื่อแบบทดสอบ",Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                }
