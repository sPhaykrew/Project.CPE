...
public class st_ex3_normal_update extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        old_Group_Check = databaseHelper.group_st_normal(old_GroupName,"Setting_ex3_normal");
    ...
    private void onClickEvent() {
        ...
        if(selectedRows.size() != 5 || selectedRows.size() > 5 ) {
            ...
            Groupname.setText("");
            Toast.makeText(st_ex3_normal_update.this, "กรุณาเลือก 5 คำ", Toast.LENGTH_SHORT).show();
        } else {
                    ...
                    if (selectedRows.size() > 0) {
                        ...
                        if (Groupname.getText().toString().length() < 3){
                            ...
                            if (Check_Group == null || GroupName.equals(old_GroupName)) {
                                ...
                                dialog.dismiss();
                                Intent intent = new Intent(st_ex3_normal_update.this,st_ex3_normal_menu.class);
                                startActivity(intent);
                                finish();
                            } else {
                                Toast.makeText(st_ex3_normal_update.this,"ชื่อแบบทดสอบซ่ำกัน กรุณาเปลี่ยนชื่อแบบทดสอบ",Toast.LENGTH_LONG).show();
                            }
                        }
                    }
                }
